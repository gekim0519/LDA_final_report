...
We see that among smokers, average number of cigarettes smoked per day for the participants throughout the study is 19.25. According to the histogram, it is highly concentrated in the value 20.

The relationship between number of cigarettes smoked per day and age seem to have a slight decreasing trend.
...
```{r}
cigpday.lmer<- glmer(cigpday ~ age + totchol + (1 | randid), data = frmgham_smoker, family = poisson, nAGQ = 0)
