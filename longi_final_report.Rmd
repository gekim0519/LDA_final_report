...
####Loop for finding confounders
```{r}
pot_conf <- names(frmgham)[-(1:5)]
pot_conf <- pot_conf[-c(grep("time", pot_conf), frmgham$death)]
...
for (conf in pot_conf) {
  ...
  data <- cbind(frmgham[,c("cursmoke", "sex")], frmgham[,conf])
