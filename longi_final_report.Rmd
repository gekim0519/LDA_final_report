...
cigpday.lmer<- glmer(cigpday ~ age + sex + educ + heartrte + prevhyp + age*sex + age:prevhyp + (1 | randid), data = frmgham_smoker, family = poisson, nAGQ = 0)
summary(cigpday.lmer)
# AIC 35492.2

cigpday.lmer<- glmer(cigpday ~ age + sex + educ + heartrte + prevhyp + hdlc + age:sex + age:prevhyp + (1 | randid), data = frmgham_smoker, family = poisson, nAGQ = 0)
summary(cigpday.lmer)
# AIC 7678.7
# need to include hdlc

# removing prevhyp and age:prevhyp add age:heartrte
cigpday.lmer<- glmer(cigpday ~ age + sex + educ + heartrte + hdlc + age:heartrte + (1 | randid), data = frmgham_smoker, family = poisson, nAGQ = 0)
summary(cigpday.lmer)
# AIC 7672.4 
